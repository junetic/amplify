...
We often say 'validate' when talking about user feedback or user research. In fact, learning from users is often called user and usability _testing_. _Testing_ assumes that you get a set of _finite results_. Analytics and data can tell you those binary results quite easily.
